...
**Cost model corrected (2026-09-22).** The paragraph above records three fixed lines and the September 2026 invoice shows more: a second instance, two IPv4 addresses, the repository snapshots, and a second domain. The restore and rehearsal box is a `cx23` at €5.49 per month, which is more than the primary's €3.99, and it runs continuously because it carries the weekly restore test, where §5.5 describes a throwaway machine. Snapshot storage is €0.0143 per GB per month for about 16 GB across three snapshots, and each IPv4 address is €0.50 per month.

At the caps on that invoice the steady state is: primary `cx23` €47.88/yr, restore `cx23` €65.88/yr, two IPv4 addresses €12.00/yr, snapshots about €2.70/yr, which is €128.49/yr or about £110 at the ECB reference rate of 0.8578 on 2026-09-22. The storage box is not on the part of the invoice read, so its line stays at the ~£30/yr recorded here and is worth confirming from the same bill, and the domains are about £12/yr for `.net` plus 11.08 USD for `.com`.
